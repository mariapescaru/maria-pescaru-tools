...
package com.escudesignatrezzi.commons.activities
...
import com.escudesignatrezzi.commons.extensions.baseConfig
import com.escudesignatrezzi.commons.extensions.getLinkTextColor
import com.escudesignatrezzi.commons.extensions.launchViewIntent
import com.escudesignatrezzi.commons.extensions.updateTextColors
import com.escudesignatrezzi.commons.helpers.APP_LICENSES
import com.escudesignatrezzi.commons.helpers.APP_NAME
import com.escudesignatrezzi.commons.helpers.APP_VERSION_NAME
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupMoreApps() {
        about_more_apps.setOnClickListener {
            launchViewIntent("https://play.google.com/store/apps/developer?id=escu-design.com")
        }
    ...
    private fun setupFacebook() {
        about_facebook.setOnClickListener {
            var link = "https://www.facebook.com/escudesign"
            try {
                packageManager.getPackageInfo("com.facebook.katana", 0)
                link = "https://www.facebook.com/escu.design/"
    ...
    private fun setupGPlus() {
        about_gplus.setOnClickListener {
            launchViewIntent("https://plus.google.com/+EscuDeSignweb")
        }
    }

    private fun setupSolunar() {
        about_solunar.setOnClickListener {
            launchViewIntent("https://play.google.com/store/apps/details?id=escudesign.com.moonfishingcalendar")
        }
    }
